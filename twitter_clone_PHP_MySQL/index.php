		...
		<script>
			$(document).ready( function() {
				...
				$('#btn_login').click(function() {
					...
					if ($('#campo_utilizador').val() == '') {
						$('#campo_utilizador').css({'border-color': '#A94442'});
						campo_vazio = true;
					} else {
						$('#campo_utilizador').css({'border-color': '#CCC'});
					}
					...
					if ($('#campo_password').val() == '') {
						...
						$('#campo_password').css({'border-color': '#CCC'});
					}
	            ...
	            <li class="<?= $erro == 1 ? 'open' : null; ?>">
					...
					<ul class="dropdown-menu" aria-labelledby="entrar">
						...
						<?php 
							...
							if ($erro == 1) {
								echo '<font color="red">O Utilizador ou password está errado!</font>';
							}
